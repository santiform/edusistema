...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="https://localhost/edusistema/resources/librerias/styleestudiantes.css">
	...
	<div class="header" >  
		...
		<div class="container" style="padding-bottom: -0.8rem;"  >
				...
				<div class="col botonytexto" > 
						...
						<a href="https://localhost/edusistema/public/estudiantes/mi-perfil" >
          ...
          <a href="https://localhost/edusistema/public/estudiantes/logout" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
